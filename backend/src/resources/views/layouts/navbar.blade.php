...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('frontend/style/application-status.css') }}" />
</head>
<body>
    
<!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top w-100" style="border-radius: 0;">
