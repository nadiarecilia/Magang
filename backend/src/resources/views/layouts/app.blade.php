    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav me-3">
        <li class="nav-item me-4">
          <a class="nav-link" href="#hero" data-scroll="hero">Beranda</a>
        </li>
        <li class="nav-item me-4">
          <a class="nav-link" href="#tentang" data-scroll="tentang">Tentang</a>
        </li>
        <li class="nav-item me-4">
          <a class="nav-link {{ request()->routeIs('jobs.index') ? 'active' : '' }}" href="{{ route('jobs.index') }}">Lihat Lowongan</a>
        </li>
        <li class="nav-item me-4">
          <a class="nav-link" href="#footer" data-scroll="footer">Kontak Kami</a>
        </li>
      </ul>
